...
const translations = {
  es: {
    ...
    "svc.s13.name": "Instalación de Videojuegos",
    "svc.s13.desc": "Instalamos y configuramos cualquier videojuego que quieras de cualquier plataforma y consola, nosotros tenemos los mejores emuladores.",
  ...
  en: {
    ...
    "svc.s13.name": "Video Game Installation",
    "svc.s13.desc": "We install and set up any video game you want, on any platform or console—we have the best emulators.",
